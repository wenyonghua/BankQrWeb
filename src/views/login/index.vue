...
import { Avatar as avatar, Lock as lock, ChromeFilled as chromefilled} from '@element-plus/icons-vue' 
...
const handleLogin = () => {
  if (loginInfo.username === 'AG005' || loginInfo.username === 'FastPay001' || loginInfo.username === 'FCTA765' || loginInfo.username === 'PMC897') {
